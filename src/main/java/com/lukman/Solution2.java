...
class Solution2
{
    ...
    public class Graph
    {
        ...
        public String shortestPath(int s)
        {
            ...
            return  printShortestDistances(dist);
        }
    }
    public void calculateShortestDistances(int dist[]){
        // Print the calculated shortest distances
    ...
    public String printShortestDistances(int dist[]){
